...
- Join the in game chat channel `DoomedFromTheStart` (<a href="#" onclick="CCPEVE.joinChannel('DoomedFromTheStart')">ingame browser link</a>).  Have it open while you're logged in and playing.  Say hello and that you're interested in checking out the corp.  Chill and chitchat with our members and friends.  (You might also be interested in joining `/v/ bros` (<a href="#" onclick="CCPEVE.joinChannel('/v/ bros')">ingame browser link</a>) to see All-Out members as a part of a larger community, but keep in mind that we are simply one group among many there.)
